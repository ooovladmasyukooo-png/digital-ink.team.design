...
export function DesignBriefDeadlinePicker({
  ...
  return createPortal(
    ...
    >
      ...
      <div className={briefStyles['db-date-pop-time']}>
        <label className={briefStyles['db-date-pop-time-toggle']}>
          <input
            type="checkbox"
            checked={timeEnabled}
            onChange={(e) => {
        ...
        <input
          type="time"
          className={briefStyles['db-date-pop-time-input']}
          value={timeValue}
      ...
      <div className={teamStyles['date-pop-foot']}>
        ...
        <button
          type="button"
          className={cx(teamStyles['date-pop-link'], briefStyles['db-date-pop-done'])}
